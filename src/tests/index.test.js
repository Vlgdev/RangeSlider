...
describe('Test View', () => {
    ...
    describe('Render', () => {
        test('default', () => {
            ...
            view = new View(model);
            const fsd = target.querySelector('.fsd');
            const inner = target.querySelector('.fsd__inner');
            const range = target.querySelector('.fsd__range');
            const sliderWrappers = target.querySelectorAll('.fsd__slider-wrapper');
            const slider = target.querySelector('.fsd__slider');
            const prompt = target.querySelectorAll('.fsd__prompt');
            const progressBar = target.querySelector('.fsd__progress');
            const scale = target.querySelector('.fsd__scale');
            const min = target.querySelector('.fsd__min');
            const max = target.querySelector('.fsd__max');
        ...
        test('interval: true', () => {
            ...
            const fsd = target.querySelector('.fsd');
            const sliderWrappers = target.querySelectorAll('.fsd__slider-wrapper');
            const prompts = target.querySelectorAll('.fsd__prompt');
            const progressBar = target.querySelector('.fsd__progress');
        ...
        test('scale of values: true', () => {
            ...
            view = new View(model);
            const spans = target.querySelectorAll('.fsd__scale > span');
